<?php
     ...
     class api {
          ...
          function createNote($title, $description){
               $getNotes = $this->db->prepare("insert into note (title, description) VALUES (:title, :description)");
          ...
          function deleteNote($id){
               ...
               return json_encode(['pesan' => 'Data Berhasil di Hapus']);
          }

          function updateNote($id, $title, $description){
               $getNotes = $this->db->prepare("UPDATE note SET title = :title,description = :description WHERE id = :id");
               $getNotes->execute(['id' => $id, 'title' => $title, 'description' => $description]);
               return json_encode(['pesan'=> 'Data Berhasil di Update']);
          }
